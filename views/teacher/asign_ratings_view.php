            ...
            <div class="card row mx-1">
                ...
                <form action="<?= constant('__baseurl__') ?>teacher/save_ratings" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-flex justify-content-around desktop-to-mobile">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control" id="seccion-asignar" name="seccion">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control" id="nivel-asignar" name="nivel">
                                    <option value="0">Seleccionar</option>
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <select class="form-control" id="materia-asignar" name="materia">
                                    <option value="0">Seleccionar</option>
                    ...
                    <div class="d-flex justify-content-center align-items-center desktop-to-mobile">
                        <button type="button" class="btn btn-primary" id="btn-asignar">Filtrar</button>
                    </div>

                    <div class="card row">
                        <div class="card-header pb-0">
                            <h6 class="text-center">Asignar Notas</h6>
                        </div>
                        <!-- row1 -->
