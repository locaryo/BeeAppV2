...
<div class="container-fluid pt-5" data-vista='registrarEstudiante'>
      ...
      <div class="card mb-4">
        ...
        <div class="row mx-1">
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            ...
            <input class="form-control" type="text" name="p_nombre" required>
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
          ...
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            ...
            <input class="form-control" type="text" name="p_apellido" required>
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
          ...
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            <label class="form-label required">Cedula</label>
            <input class="form-control" type="number" name="cedula" required>
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            <label class="form-label">Telefono</label>
            <input class="form-control" type="number" placeholder="04121234567" name="telefono">
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
          ...
          <div class="form-group col-12 col-sm-6 col-md-3 px-2 position-relative">
            <label class="form-label required">C.I. del Representante</label>
            <input class="form-control" id="filtrar-representante" role="listbox" autocomplete="off" name="ci_representante" required>
            <datalist class="filterable-list p-1 overflow-y-auto rounded-0 rounded-bottom position-absolute bg-white border-bottom border-end border-start border-primary" id="representantesList">
            </datalist>
            <input type="text" class="d-none" id="representante-id" name="id-representante">
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            <label class="form-label required">Direccion</label>
            <input class="form-control" type="text" placeholder="comunidad, calle, casa" name="direccion" required>
          </div>
          <div class="form-group col-12 col-sm-6 col-md-3 px-2">
            <label class="form-label">Documentos Entregados</label>
            <input class="form-control" type="text" placeholder="partida de nacimiento, etc" name="documentos" required>
          </div>
